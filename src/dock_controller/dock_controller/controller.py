...
class DockController(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('approach_linear_speed', 0.025)
        self.declare_parameter('marker_timeout_sec', 1.5)
        ...
        self.declare_parameter('command_move_sec', 1.0)
        self.declare_parameter('command_rest_sec', 3.0)
